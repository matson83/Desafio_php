...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
            ...
            <!-- Page Content -->
            <main>
                <Alert v-if="$page.props.flash.success" :message="$page.props.flash.success" type="success" />
                <Alert v-if="$page.props.flash.error" :message="$page.props.flash.error" type="error" />
                <slot />
            </main>
        </div>
    </div>
